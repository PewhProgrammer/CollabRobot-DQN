...
function LineNavigator(e, t, n) {
  function c(e, t) {
    ...
    return !n
      ? null
      : { offset: t.indexOf(n[0]), length: n[0].length, line: t };
  }
  var r = this;
  ...
  var f = function(e, t, n, r) {
    ...
    var c = { firstLine: r, lastLine: a, offset: t, length: f };
    if (u) i.push(c);
    var h = Object.create(c);
    h.place = { firstLine: a + 1, offset: t + f };
    return h;
  };
...
function FileNavigator(e) {
  ...
  var i = 0,
    ...
    s = new LineNavigator(a, o, { chunkSize: 4194304 });
